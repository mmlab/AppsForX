            ...
            <?php if (have_posts()) : ?>
                <?php while ( have_posts() ) : the_post(); ?>
					<?php
						...
						$connected_ideas = new WP_Query( array(
							'connected_type' => 'events_to_ideas',
							'connected_items' => $post,
							'nopaging' => true,
						) );
						$connected_apps = new WP_Query( array(
							'connected_type' => 'apps_to_events',
							'connected_items' => $post,
							'nopaging' => true,
						) );
					?>
						...
						<div class="entry-content" >
							<div class="entry-block general-info">
								<?php if($meta['logo'][0]): ?>	
									<div class="info-block image" rel="schema:logo">
										<?php echo wp_get_attachment_image($meta['logo'][0], 'large'); ?>  
									</div>
								<?php endif ?>
								...
								<div class="info-block edition">
									...
									<span class="value" property="apps4X:edition"><?php echo esc_attr($meta['edition'][0]); ?></span>
								</div>
								<?php endif ?>
								...
								<div class="info-block starttime">
									<span class="description"></span> 
									<span class="value" property="schema:startDate" content="<?php echo date('Y-m-d\TH:i:s', $meta['when_start'][0]); ?>" >
							...
							<div class="entry-block organizers">
								...
								<div class="value">
									<?php foreach((array)$meta['organizer'] as $organizer) { 
										...
										if ($coordinator) {
									?>
									<div class="coordinator" rel = "apps4X:coordinator"><span class="coordinator-desc">Coordinator:&#160;</span>
							...
							<div class="entry-block sponsors">
								...
								<div class="value" rel="apps4X:sponsor">
									...
									<div class="image" rel="schema:logo">
										<?php echo wp_get_attachment_image($sponsor['sponsor-logo']); ?>  
									</div>
									<?php endif ?>
									<p class="sponsor" about = "<?php echo "http://apps4europe.eu/cocreation_events/" . urlencode($sponsor_name); ?>"  typeof="foaf:Agent">
							...
							<div class="entry-block jury">
								...
								<div class="value">
									...
									<div class="jury" rel="apps4X:jury">
										<div class="value"><?php echo esc_attr($jury['jury-name']) ; ?></div>
										<div class="jurymembers">
											<?php foreach ((array)$jury['jury-members'] as $member) {
												$member = unserialize($member);
												list($lastname, $name) = array(esc_attr($member['agent-surname']), esc_attr($member['agent-name']));
											?>
											<!-- TODO jury members part of the output? -->
											<!-- TODO jury members are not saved! -->
							...
							<div class="entry-block awards" >
								...
								<?php foreach((array)$meta['award'] as $award) {
									...
									?>
									<?php if($award['award-sponsor-logo']): ?>	
									<div class="image" rel="schema:logo">
										<?php echo wp_get_attachment_image($award['award-sponsor-logo']); ?>  
									</div>
									<?php endif ?>
							...
							<!-- <hr /> -->
							<?php if ( $connected_ideas->have_posts() ) : ?>
							<div class="entry-block ideas" >
								<h2>Ideas</h2>
								<ul class="value" rel="apps4X:submission">
								<?php while ( $connected_ideas->have_posts() ) : $connected_ideas->the_post(); ?>
							...
							<!-- <hr /> -->
							<?php if ( $connected_apps->have_posts() ) : ?>
							<div class="entry-block apps" >
								<h2>Apps</h2>
								<ul class="value" rel="apps4X:submission">
								<?php while ( $connected_apps->have_posts() ) : $connected_apps->the_post(); ?>
